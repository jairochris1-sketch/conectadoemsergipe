...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    "search": "Buscar...",
    "index.description": "Thefacebook es un directorio en línea que conecta personas a través de redes sociales en universidades.",
    ...
    "login.welcome_title": "[ Bienvenido a Thefacebook ]",
    "login.welcome_text": "Thefacebook es un directorio en línea que conecta personas a través de redes sociales en universidades.",
    "login.opened": "Hemos abierto Thefacebook para consumo popular en",
    "login.use_for": "Puedes usar Thefacebook para:",
