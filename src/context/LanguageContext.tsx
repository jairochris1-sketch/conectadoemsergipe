...
const translations: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    "login.welcome_bar": "¡Bienvenido a Thefacebook!",
    "register.title": "Registro en [ thefacebook ]",
    "register.description": "Thefacebook es un directorio social para estudiantes universitarios.",
